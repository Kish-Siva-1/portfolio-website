        ...
        <section class="page-section mb-0" id="about">
            <div class="container">
                ...
                <div id="around" className="col-lg-4 mb-5 mb-lg-0 mx-auto">
                    ...
                    <a className="btn btn-outline-secondary btn-social mx-1" target="_blank" href="https://github.com/Kish-Siva-1/">
                        <FontAwesomeIcon icon={faGithub} style={{ fontSize: "1.4em" }} />
                    </a>
                    <a className="btn btn-outline-secondary btn-social mx-1" target="_blank" href="https://linkedin.com/in/kishsiva">
